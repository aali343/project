...
if __name__ == "__main__":
    ...
    parser.add_argument('--src_name', type=str, nargs='+', default=['belady.flac'], help='Sample source name')
    parser.add_argument('--trg_name', type=str, nargs='+', default=['src.flac'], help='Sample target name')
